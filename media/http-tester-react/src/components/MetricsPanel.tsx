...
export const MetricsPanel: React.FC<MetricsPanelProps> = ({
  ...
  return (
    <div className="flex flex-col gap-6 w-full font-mono">
      <div className="bg-bgPanel border-2 border-borderDark p-4 flex items-center gap-3 shadow-retro-dark">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* HTTP Metrics */}
        <div className="bg-bgDark border-2 border-borderDark rounded-none p-5 shadow-retro-dark flex flex-col gap-4">
          ...
          {!hasHttp ? (
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-bgPanel border-2 border-borderDark p-3 flex flex-col gap-1">
              ...
              <div className="mt-2 flex flex-col gap-2">
                ...
                <div className="bg-bgPanel border-2 border-borderDark p-3 text-xs text-accentLight overflow-x-auto whitespace-nowrap">
                  {httpState?.url || 'N/A'}
                </div>
              </div>
              ...
              <div className="mt-4 flex flex-col gap-1">
                ...
                <div className="w-full h-4 bg-bgPanel border-2 border-borderDark flex">
                  <div 
